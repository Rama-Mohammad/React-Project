...
const StepsSection = () => {
  return (
    <section className="pt-3 pb-10">
      <div className="mx-auto max-w-7xl rounded-[1.5rem] border border-white/40 bg-white/60 px-4 py-7 backdrop-blur-xl sm:px-6 lg:px-8">
        <p className="mb-2 text-center text-xs font-semibold uppercase tracking-wider text-indigo-500">
          Four steps
        </p>

        <h2 className="mb-4 text-center text-2xl font-bold leading-tight text-slate-900 md:text-3xl lg:text-4xl">
