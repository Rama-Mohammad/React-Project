...
const StatsSection = () => {
  return (
    <section className="pt-8 pb-24">
      <div className="mx-auto max-w-7xl rounded-[1.5rem] border border-white/40 bg-white/70 px-4 py-7 shadow-sm backdrop-blur-xl sm:px-6 lg:px-8">
        <div className="text-center">
          <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-indigo-500">
            By the numbers
          </p>

          <h2 className="mb-4 text-2xl font-bold leading-tight text-slate-900 md:text-3xl lg:text-4xl">
